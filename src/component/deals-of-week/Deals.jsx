      ...
      <section className="deals-of-week">
        <div className="card">
          ...
          <div className="prices">
            <p className="discount-div">-35%</p>
            <p className="cancle-amt">₹719</p>
            <p className="discount-amt">₹467.35</p>
          </div>
        </div>
        <div className="card">
          <div className="card-img">
          ...
          <div className="prices">
            <p className="discount-div">-20%</p>
            <p className="cancle-amt">₹1,399</p>
            <p className="discount-amt">₹1,119.20</p>
          </div>
        </div>
        <div className="card">
          <div className="card-img">
